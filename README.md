**Update: we're extending this project to build Daisy, an event analytics platform designed to help analysts move from ad hoc analysis to actionable business insights faster. Learn more at [https://daisyhq.com](https://daisyhq.com).**
